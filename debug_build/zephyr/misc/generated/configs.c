...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SOLOMON_SSD1306FB_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF52DK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CORTEX_M_DEBUG_MONITOR_HOOK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UTF8, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_COUNT_EXTRA, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_NOTIFY_RETRY_DELAY, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_CODEC_CFG_MAX_DATA_SIZE, 19);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_CODEC_CFG_MAX_METADATA_SIZE, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_BASS_MAX_SUBGROUPS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_CODEC_CAP_MAX_DATA_SIZE, 19);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_CODEC_CAP_MAX_METADATA_SIZE, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_VOCS_MAX_INSTANCE_COUNT, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_VOCS_CLIENT_MAX_INSTANCE_COUNT, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AICS_MAX_INSTANCE_COUNT, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AICS_CLIENT_MAX_INSTANCE_COUNT, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_VCP_VOL_CTLR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_VCP_VOL_CTLR_MAX_VOCS_INST, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_VCP_VOL_CTLR_MAX_AICS_INST, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CSIP_SET_COORDINATOR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CSIP_SET_COORDINATOR_MAX_CSIS_INSTANCES, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CSIP_SET_COORDINATOR_ENC_SIRK_SUPPORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HAS_CLIENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_TMAP_LOG_LEVEL_INHERIT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_TMAP_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GMAP_LOG_LEVEL_INHERIT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GMAP_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_FILTER_ACCEPT_LIST, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_TX_USER_DATA_SIZE, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_FRAG_COUNT, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RPA_TIMEOUT_DYNAMIC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_BUF_COUNT, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_FRAG_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ATT_TX_COUNT, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ATT_PREPARE_COUNT, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATT_AUTO_UPDATE_MTU, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_CENTRAL_RESERVE_MAX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_LLCP_CONN, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_LLCP_REMOTE_PROC_CTX_BUF_NUM, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CSIP_SET_COORDINATOR_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CSIP_SET_COORDINATOR_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CSIP_SET_MEMBER_CRYPTO_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CSIP_SET_MEMBER_CRYPTO_LOG_LEVEL_DBG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_DEBUGMON, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BUFFER_SIZE, 8192);
